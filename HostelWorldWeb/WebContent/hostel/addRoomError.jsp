...
<jsp:include page="../common/including.jsp">
    <jsp:param name="title" value="添加房间失败"/>
</jsp:include>
  </head>
  ...
  <body class=""> 
    ...
    <div class="row-fluid">
	    <div class="dialog">
	        <div class="block">
	            <p class="block-heading">添加房间失败</p>
	            <div class="block-body">
	            	<label>错误信息</label>
	            	<p><%=session.getAttribute("addroom_message") %></p>
	            	<a href="<%= request.getContextPath()+"/user" %>" class="btn btn-default pull-right">返回</a>
	            	<a href="<%= request.getContextPath()+"/hostel/roomManage.jsp" %>" class="btn btn-primary pull-right">重新添加</a>
