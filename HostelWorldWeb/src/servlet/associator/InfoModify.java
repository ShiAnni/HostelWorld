 ...
 */
@WebServlet("/associator/info/modify/pre")
public class InfoModify extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Card card = userInfoService.getAssociator(login);
		session.setAttribute("associator", card);
		ServletContext context = request.getServletContext();
		context.getRequestDispatcher("/associator/modifyInfo.jsp").forward(request, response);
