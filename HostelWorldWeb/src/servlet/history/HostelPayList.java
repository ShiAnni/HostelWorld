 ...
 */
@WebServlet("/hostel/pay/list")
public class HostelPayList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Income> incomes = historyService.getHostelPayList(login);
		session.setAttribute("incomes", incomes);
		ServletContext context = request.getServletContext();
		context.getRequestDispatcher("/hostel/payList.jsp").forward(request, response);
	}
